<?php
$aboutSmallTitle = get_post_meta(get_the_ID(), "About Small Title", true);
$aboutMainTitle = get_post_meta(get_the_ID(), "About Main Title", true);
$aboutTabOne = get_post_meta(get_the_ID(), "About Tab One", true);
$aboutTabTwo = get_post_meta(get_the_ID(), "About Tab Two", true);
$aboutTabThree = get_post_meta(get_the_ID(), "About Tab Three", true);
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="about-image-five">
                    ...
                    <?php
                    if (is_active_sidebar('about_area-1')) {
            ...
            <div class="col-lg-6 col-12">
                <div class="about-five-content">
                    <h6 class="small-title text-lg">
                        <?php echo esc_html($aboutSmallTitle); ?>
                    </h6>
                    <h2 class="main-title fw-bold">
                        <?php echo esc_html($aboutMainTitle); ?>
                    </h2>
                    <div class="about-five-tab">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-history-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">
                                    <?php echo esc_html($aboutTabThree); ?>
                                </button>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade active show" id="nav-who" role="tabpanel"
                                ...
                                <?php
                                if (is_active_sidebar('about_area-tab-1')) {
                                    dynamic_sidebar('about_area-tab-1');
                                }
                                ?>
                            ...
                            <div class="tab-pane fade" id="nav-vision" role="tabpanel" aria-labelledby="nav-vision-tab">
                                <?php
                                if (is_active_sidebar('about_area-tab-2')) {
                                    dynamic_sidebar('about_area-tab-2');
                                }
                                ?>
                            </div>
                            <div class="tab-pane fade" id="nav-history" role="tabpanel"
                                ...
                                <?php
                                if (is_active_sidebar('about_area-tab-3')) {
                                    dynamic_sidebar('about_area-tab-3');
                                }
                                ?>
                            </div>
                        </div>
